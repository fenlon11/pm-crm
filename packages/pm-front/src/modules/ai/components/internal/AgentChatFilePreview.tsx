...
import { type ExtendedFileUIPart } from 'pm-shared/ai';
import { isDefined } from 'pm-shared/utils';
import { AvatarOrIcon, Chip, ChipVariant } from 'pm-ui/components';
import { type IconComponent, IconX } from 'pm-ui/display';
