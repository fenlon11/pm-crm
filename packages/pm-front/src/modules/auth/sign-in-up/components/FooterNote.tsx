...
export const FooterNote = () => {
  ...
  if (!isOnAWorkspace) {
    return (
      <StyledCopyContainer>
        <Trans>By using Persistent Recruiter, you agree to the</Trans>{' '}
        <a
          href="https://persistentmomentum.com/legal/terms"
          target="_blank"
        ...
        <Trans>and</Trans>{' '}
        <a
          href="https://persistentmomentum.com/legal/privacy"
          target="_blank"
          rel="noopener noreferrer"
        >
