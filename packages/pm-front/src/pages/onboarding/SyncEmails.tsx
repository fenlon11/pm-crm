...
import { ModalContent } from 'pm-ui/layout';
import { useHotkeysOnFocusedElement } from '@/ui/utilities/hotkey/hooks/useHotkeysOnFocusedElement';
import { t } from '@lingui/core/macro';
import { AppPath, ConnectedAccountProvider } from 'pm-shared/types';
import { IconGoogle, IconMicrosoft } from 'pm-ui/display';
import { MainButton } from 'pm-ui/input';
import { ClickToActionLink } from 'pm-ui/navigation';
import { ThemeContext, themeCssVariables } from 'pm-ui/theme-constants';
...
export const SyncEmails = () => {
  ...
  return (
    <ModalContent isVerticallyCentered isHorizontallyCentered>
      ...
      <SubTitle>
        {t`Sync your Emails and Calendar with Persistent Recruiter. Choose your privacy settings.`}
      </SubTitle>
