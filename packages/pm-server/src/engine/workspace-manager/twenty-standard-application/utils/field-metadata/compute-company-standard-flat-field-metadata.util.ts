...
>): Record<AllStandardObjectFieldName<'company'>, FlatFieldMetadata> => ({
  ...
  candidates: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`Candidates linked to the company`),
      icon: 'IconUsers',
      isNullable: true,
  ...
  jobs: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'jobs',
      label: i18nLabel(msg`Jobs`),
      description: i18nLabel(msg`Jobs linked to the company`),
      icon: 'IconBriefcase',
      isNullable: true,
  ...
  stage: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`The company's pipeline stage`),
      icon: 'IconProgressCheck',
      isNullable: false,
      defaultValue: "'NEW'",
      options: [
        {
          id: '20202020-c0f1-40f1-80f1-c0aba11c0001',
          value: 'NEW',
        ...
        {
          id: '20202020-c0f2-40f2-80f2-c0aba11c0001',
          value: 'ATTEMPTED_CONTACT',
          label: i18nLabel(msg`Attempted Contact`),
          position: 1,
          color: 'purple',
        },
        {
          id: '20202020-c0f3-40f3-80f3-c0aba11c0001',
          value: 'CONTACTED',
        ...
        {
          id: '20202020-c0f4-40f4-80f4-c0aba11c0001',
          value: 'APPOINTMENT_SET',
          label: i18nLabel(msg`Appointment Set`),
          position: 3,
          color: 'turquoise',
        },
        {
          id: '20202020-c0f5-40f5-80f5-c0aba11c0001',
          value: 'APPOINTMENT_MET',
          label: i18nLabel(msg`Appointment Met`),
          position: 4,
          color: 'yellow',
        },
        {
          id: '20202020-c0f6-40f6-80f6-c0aba11c0001',
          value: 'ACTIVE_FOLLOW_UP',
          label: i18nLabel(msg`Active Follow Up`),
          position: 5,
          color: 'orange',
        },
        {
          id: '20202020-c0f7-40f7-80f7-c0aba11c0001',
          value: 'SIGNED',
        ...
        {
          id: '20202020-c0f8-40f8-80f8-c0aba11c0001',
          value: 'ONBOARDING',
          label: i18nLabel(msg`Onboarding`),
          position: 7,
          color: 'pink',
        },
        {
          id: '20202020-c0f9-40f9-80f9-c0aba11c0001',
          value: 'NURTURE',
          label: i18nLabel(msg`Nurture`),
          position: 8,
          color: 'gray',
        },
        {
          id: '20202020-c0fa-40fa-80fa-c0aba11c0001',
          value: 'ARCHIVE',
