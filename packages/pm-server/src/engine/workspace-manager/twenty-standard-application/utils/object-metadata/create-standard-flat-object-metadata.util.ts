...
export const STANDARD_FLAT_OBJECT_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  candidate: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        labelSingular: i18nLabel(msg`Candidate`),
        labelPlural: i18nLabel(msg`Candidates`),
        description: i18nLabel(msg`A job candidate`),
        icon: 'IconUserSearch',
        labelIdentifierFieldMetadataName: 'name',
      },
      workspaceId,
  ...
  job: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'job'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'job',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.job.universalIdentifier,
        nameSingular: 'job',
        namePlural: 'jobs',
        labelSingular: i18nLabel(msg`Job`),
        labelPlural: i18nLabel(msg`Jobs`),
        description: i18nLabel(msg`A job posting`),
        icon: 'IconBriefcase',
        labelIdentifierFieldMetadataName: 'title',
      },
      workspaceId,
  ...
  video: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'video'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'video',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.video.universalIdentifier,
        nameSingular: 'video',
        namePlural: 'videos',
        labelSingular: i18nLabel(msg`Video`),
        labelPlural: i18nLabel(msg`Videos`),
        description: i18nLabel(msg`A candidate video intro`),
        icon: 'IconVideoPlus',
        labelIdentifierFieldMetadataName: 'name',
      },
      workspaceId,
