import { AUTO_SELECT_SMART_MODEL_ID } from 'pm-shared/constants';
  ...
  helper: (args: Omit<CreateStandardAgentArgs, 'context'>) =>
    createStandardAgentFlatMetadata({
      ...
      context: {
        ...
        label: 'Helper',
        description:
          'AI agent specialized in helping users learn how to use Persistent Recruiter',
        icon: 'IconHelp',
        prompt: `You are a Helper Agent for Persistent Recruiter. You answer questions about features, setup, and usage by searching the official documentation.
...
Always base answers on official Persistent Recruiter documentation. Be patient and helpful.`,
