...
import ms from 'ms';
import { SendEmailVerificationLinkEmail } from 'pm-emails';
import { type APP_LOCALES } from 'pm-shared/translations';
import { AppPath } from 'pm-shared/types';
import { assertIsDefinedOrThrow, isDefined } from 'pm-shared/utils';
  ...
  async sendVerificationEmail({
    ...
    const emailVerificationMsg =
      verificationTrigger === EmailVerificationTrigger.EMAIL_UPDATE
        ...
        : msg`Welcome to Persistent Recruiter: Please Confirm Your Email`;
