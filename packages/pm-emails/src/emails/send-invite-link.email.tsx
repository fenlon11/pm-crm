...
import { getImageAbsoluteURI } from 'pm-shared/utils';
...
export const SendInviteLinkEmail = ({
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      <Title value={i18n._('Join your team on Persistent Recruiter')} />
      <MainText>
        <Trans
...
SendInviteLinkEmail.PreviewProps = {
  link: 'https://app.persistentmomentum.com/invite/123',
  workspace: {
    name: 'Acme Inc.',
