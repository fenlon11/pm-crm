...
export const DOCUMENTATION_PATHS = {
  ...
  TWENTY_UI_DISPLAY_APP_TOOLTIP: '/pm-ui/display/app-tooltip',
  TWENTY_UI_DISPLAY_CHECKMARK: '/pm-ui/display/checkmark',
  TWENTY_UI_DISPLAY_CHIP: '/pm-ui/display/chip',
  TWENTY_UI_DISPLAY_ICONS: '/pm-ui/display/icons',
  TWENTY_UI_DISPLAY_SOON_PILL: '/pm-ui/display/soon-pill',
  TWENTY_UI_DISPLAY_TAG: '/pm-ui/display/tag',
  TWENTY_UI_INPUT_BLOCK_EDITOR: '/pm-ui/input/block-editor',
  TWENTY_UI_INPUT_BUTTONS: '/pm-ui/input/buttons',
  TWENTY_UI_INPUT_CHECKBOX: '/pm-ui/input/checkbox',
  TWENTY_UI_INPUT_COLOR_SCHEME: '/pm-ui/input/color-scheme',
  TWENTY_UI_INPUT_ICON_PICKER: '/pm-ui/input/icon-picker',
  TWENTY_UI_INPUT_IMAGE_INPUT: '/pm-ui/input/image-input',
  TWENTY_UI_INPUT_RADIO: '/pm-ui/input/radio',
  TWENTY_UI_INPUT_SELECT: '/pm-ui/input/select',
  TWENTY_UI_INPUT_TEXT: '/pm-ui/input/text',
  TWENTY_UI_INPUT_TOGGLE: '/pm-ui/input/toggle',
  TWENTY_UI_INTRODUCTION: '/pm-ui/introduction',
  TWENTY_UI_NAVIGATION: '/pm-ui/navigation',
  TWENTY_UI_NAVIGATION_BREADCRUMB: '/pm-ui/navigation/breadcrumb',
  TWENTY_UI_NAVIGATION_LINKS: '/pm-ui/navigation/links',
  TWENTY_UI_NAVIGATION_MENU_ITEM: '/pm-ui/navigation/menu-item',
  TWENTY_UI_NAVIGATION_NAVIGATION_BAR: '/pm-ui/navigation/navigation-bar',
  TWENTY_UI_NAVIGATION_STEP_BAR: '/pm-ui/navigation/step-bar',
  TWENTY_UI_PROGRESS_BAR: '/pm-ui/progress-bar',
